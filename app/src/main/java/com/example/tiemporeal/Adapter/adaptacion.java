package com.example.tiemporeal.Adapter;
...
import com.example.tiemporeal.R;


import java.util.ArrayList;

public class adaptacion extends RecyclerView.Adapter<adaptacion.MyViewHolder> {
    Context context;
    ArrayList<Productos>list;

    public adaptacion(Context context, ArrayList<Productos> list) {
