...
import com.example.tiemporeal.Modelo.Usuario;
...
public class Persona extends AppCompatActivity {
    ...
    private void iniciarControles(){
        ...
        spnPais=findViewById(R.id.spinner2);
        String []opciones={"Seleccione su Pais","Ecuador","Colombia","Cuba","Corea del Norte"};
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(this,R.layout.spinner,opciones);
        spnPais.setAdapter(adapter);
        rbMasculino=findViewById(R.id.rbhombre);
        rbFemenino=findViewById(R.id.rbmujer);
